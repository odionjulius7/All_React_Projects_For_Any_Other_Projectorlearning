...
## how to added item to todo/any list final->src->App.js

## how to implement alert notification when you take any action such as update/edit an action, added, delete etc.

## best way to clear the alert notification at specific timeOut using useEffect, and dependency array: <Alert />

## best way to add item and delete individual item

### Using LocalStorage to SET And GET that data -> so that when u restart ur app-page

# u won't lose the data on the page

## and the best way to implement localStorage
