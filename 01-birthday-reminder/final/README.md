# all this explanation is from the video from youtube (code 15 react project-complete course) by john smilga 8:55minutes upward for git, netlify and redirect 
...
# 3: in package.json always change the "build": "react-scripts build" to "build": "CI= react-scripts build" cos of the the build error netlify always encounter and it always help you rebuild in netlify when you push changes to github 
...
## Idea ## on the video from youtube (code 15 react project-complete course)
